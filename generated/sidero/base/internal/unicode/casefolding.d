...
export extern(C) immutable(dstring) sidero_utf_lut_getCaseFolding(dchar input) @trusted nothrow @nogc pure {
    if (input >= 0x41 && input <= 0xFF3A) {
        if (input <= 0x2CF2) {
            if (input <= 0x5A)
            ...
            else if (input >= 0x1C80 && input <= 0x1C89)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(297 + (input - 0x1C80))];
            else if (input >= 0x1C90 && input <= 0x1CBF)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(307 + (input - 0x1C90))];
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(355 + (input - 0x1E96))];
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(360 + (input - 0x1F08))];
            else if (input >= 0x1F18 && input <= 0x1F1D)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(368 + (input - 0x1F18))];
            else if (input >= 0x1F28 && input <= 0x1F2F)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(374 + (input - 0x1F28))];
            else if (input >= 0x1F38 && input <= 0x1F3F)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(382 + (input - 0x1F38))];
            else if (input >= 0x1F48 && input <= 0x1F4D)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(390 + (input - 0x1F48))];
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(396 + (input - 0x1F68))];
            else if (input >= 0x1F80 && input <= 0x1FBC)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(404 + (input - 0x1F80))];
            else if (input == 0x1FBE)
                return cast(dstring)LUT_9E8CB5FE_DString[131 .. 132];
            else if (input >= 0x1FC2 && input <= 0x1FCC)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(465 + (input - 0x1FC2))];
            else if (input >= 0x1FD2 && input <= 0x1FDB)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(476 + (input - 0x1FD2))];
            else if (input >= 0x1FE2 && input <= 0x1FEC)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(486 + (input - 0x1FE2))];
            else if (input >= 0x1FF2 && input <= 0x1FFC)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(497 + (input - 0x1FF2))];
            else if (input == 0x2126)
                return cast(dstring)LUT_9E8CB5FE_DString[397 .. 398];
            else if (input >= 0x212A && input <= 0x212B)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(508 + (input - 0x212A))];
            else if (input == 0x2132)
                return cast(dstring)LUT_9E8CB5FE_DString[398 .. 399];
            else if (input >= 0x2160 && input <= 0x216F)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(510 + (input - 0x2160))];
            else if (input == 0x2183)
                return cast(dstring)LUT_9E8CB5FE_DString[399 .. 400];
            else if (input >= 0x24B6 && input <= 0x24CF)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(526 + (input - 0x24B6))];
            else if (input >= 0x2C00 && input <= 0x2C2F)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(552 + (input - 0x2C00))];
            else if (input == 0x2C60)
                return cast(dstring)LUT_9E8CB5FE_DString[400 .. 401];
            else if (input >= 0x2C62 && input <= 0x2C64)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(600 + (input - 0x2C62))];
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(603 + (input - 0x2C6D))];
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(607 + (input - 0x2C7E))];
            ...
            if (input == 0xA640)
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(610 + (input - 0xA77D))];
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(612 + (input - 0xA7AA))];
                ...
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(623 + (input - 0xA7C4))];
            else if (input == 0xA7C9)
                return cast(dstring)LUT_9E8CB5FE_DString[560 .. 561];
            else if (input >= 0xA7CB && input <= 0xA7CC)
                return cast(dstring)LUT_9E8CB5FE[cast(size_t)(627 + (input - 0xA7CB))];
    ...
    if (input >= 0x41 && input <= 0xFF3A) {
        if (input <= 0x2CF2) {
            if (input <= 0x5A)
                ...
                return cast(dchar)LUT_25074147[cast(size_t)(306 + (input - 0x1C90))];
            else if (input == 0x1E00)
                ...
                return cast(dchar)LUT_25074147[cast(size_t)(354 + (input - 0x1F08))];
            else if (input >= 0x1F18 && input <= 0x1F1D)
                return cast(dchar)LUT_25074147[cast(size_t)(362 + (input - 0x1F18))];
            else if (input >= 0x1F28 && input <= 0x1F2F)
                return cast(dchar)LUT_25074147[cast(size_t)(368 + (input - 0x1F28))];
            else if (input >= 0x1F38 && input <= 0x1F3F)
                return cast(dchar)LUT_25074147[cast(size_t)(376 + (input - 0x1F38))];
            else if (input >= 0x1F48 && input <= 0x1F4D)
                return cast(dchar)LUT_25074147[cast(size_t)(384 + (input - 0x1F48))];
            else if (input == 0x1F59)
                ...
                return cast(dchar)LUT_25074147[cast(size_t)(390 + (input - 0x1F68))];
            else if (input >= 0x1F88 && input <= 0x1F8F)
                return cast(dchar)LUT_25074147[cast(size_t)(398 + (input - 0x1F88))];
            else if (input >= 0x1F98 && input <= 0x1F9F)
                return cast(dchar)LUT_25074147[cast(size_t)(406 + (input - 0x1F98))];
            else if (input >= 0x1FA8 && input <= 0x1FAF)
                return cast(dchar)LUT_25074147[cast(size_t)(414 + (input - 0x1FA8))];
            else if (input >= 0x1FB8 && input <= 0x1FBC)
                return cast(dchar)LUT_25074147[cast(size_t)(422 + (input - 0x1FB8))];
            else if (input == 0x1FBE)
                return cast(dchar)0x3B9;
            else if (input >= 0x1FC8 && input <= 0x1FCC)
                return cast(dchar)LUT_25074147[cast(size_t)(427 + (input - 0x1FC8))];
            else if (input == 0x1FD3)
                return cast(dchar)0x390;
            else if (input >= 0x1FD8 && input <= 0x1FDB)
                return cast(dchar)LUT_25074147[cast(size_t)(432 + (input - 0x1FD8))];
            else if (input == 0x1FE3)
                return cast(dchar)0x3B0;
            else if (input >= 0x1FE8 && input <= 0x1FEC)
                return cast(dchar)LUT_25074147[cast(size_t)(436 + (input - 0x1FE8))];
            else if (input >= 0x1FF8 && input <= 0x1FFC)
                return cast(dchar)LUT_25074147[cast(size_t)(441 + (input - 0x1FF8))];
            else if (input == 0x2126)
                return cast(dchar)0x3C9;
            else if (input >= 0x212A && input <= 0x212B)
                return cast(dchar)LUT_25074147[cast(size_t)(446 + (input - 0x212A))];
            else if (input == 0x2132)
                return cast(dchar)0x214E;
            else if (input >= 0x2160 && input <= 0x216F)
                return cast(dchar)LUT_25074147[cast(size_t)(448 + (input - 0x2160))];
            else if (input == 0x2183)
                return cast(dchar)0x2184;
            else if (input >= 0x24B6 && input <= 0x24CF)
                return cast(dchar)LUT_25074147[cast(size_t)(464 + (input - 0x24B6))];
            else if (input >= 0x2C00 && input <= 0x2C2F)
                return cast(dchar)LUT_25074147[cast(size_t)(490 + (input - 0x2C00))];
            else if (input == 0x2C60)
                return cast(dchar)0x2C61;
            else if (input >= 0x2C62 && input <= 0x2C64)
                return cast(dchar)LUT_25074147[cast(size_t)(538 + (input - 0x2C62))];
            else if (input == 0x2C67)
                ...
                return cast(dchar)LUT_25074147[cast(size_t)(541 + (input - 0x2C6D))];
            else if (input == 0x2C72)
                return cast(dchar)0x2C73;
            else if (input == 0x2C75)
                return cast(dchar)0x2C76;
            else if (input >= 0x2C7E && input <= 0x2C80)
                return cast(dchar)LUT_25074147[cast(size_t)(545 + (input - 0x2C7E))];
            else if (input == 0x2C82)
            ...
            if (input == 0xA640)
                ...
                return cast(dchar)LUT_25074147[cast(size_t)(548 + (input - 0xA77D))];
            else if (input == 0xA780)
                ...
                return cast(dchar)LUT_25074147[cast(size_t)(550 + (input - 0xA7AA))];
            else if (input == 0xA7B6)
                ...
                return cast(dchar)LUT_25074147[cast(size_t)(561 + (input - 0xA7C4))];
            else if (input == 0xA7C9)
                return cast(dchar)0xA7CA;
            else if (input >= 0xA7CB && input <= 0xA7CC)
                return cast(dchar)LUT_25074147[cast(size_t)(565 + (input - 0xA7CB))];
            else if (input == 0xA7D0)
