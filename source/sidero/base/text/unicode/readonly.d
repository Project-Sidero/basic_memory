...
@safe:
    ...
    */
    ...
    bool opEquals(scope StringBuilder_UTF8 other) scope const @trusted {
        return other.opEquals(*cast(String_UTF!Char*)&this);
    }
    ...
    bool ignoreCaseEquals(scope String_ASCII other, scope RCAllocator allocator = RCAllocator.init,
            UnicodeLanguage language = UnicodeLanguage.Unknown) scope const @trusted {
        return (*cast(String_UTF!Char*)&this).ignoreCaseEqualsImplReadOnly(other, allocator, language);
    }
    ...
    int opCmp(scope const(char)[] other) scope const @trusted {
        return (*cast(String_UTF!Char*)&this).opCmpImplSlice(other);
    }
    ...
    int opCmp(scope String_ASCII other) scope const @trusted {
        return (*cast(String_UTF!Char*)&this).opCmpImplReadOnly(other);
    }
    ...
    int opCmp(scope StringBuilder_UTF8 other) scope const @trusted {
        return -other.opCmp(*cast(String_UTF!Char*)&this);
    }
    ...
    int ignoreCaseCompare(scope String_UTF8 other, scope RCAllocator allocator = RCAllocator.init,
            UnicodeLanguage language = UnicodeLanguage.Unknown) scope const @trusted {
        return (*cast(String_UTF!Char*)&this).ignoreCaseCompareImplReadOnly(other, allocator, language);
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ " def"c;
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ " def"w;
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ " def"d;
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ String_UTF8(" def");
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ String_UTF16(" def"w);
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ String_UTF32(" def"d);
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ String_ASCII(" def");
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ StringBuilder_UTF8(" def");
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ StringBuilder_UTF16(" def"w);
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ StringBuilder_UTF32(" def"d);
        assert(got == "abc def");
    }
    ...
    ///
    unittest {
        StringBuilder_UTF!Char got = String_UTF!Char("abc") ~ StringBuilder_ASCII(" def");
        assert(got == "abc def");
    }
