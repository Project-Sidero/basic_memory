...
@safe:
    ...
    ///
    bool opEquals(ConcurrentLinkedList!Type other) scope {
    ...
    ///
    int opCmp(ConcurrentLinkedList!Type other) scope {
        other = other.save;
    ...
    @property {
        ...
        ///
        ConcurrentLinkedList!Type save() {
            if(isNull)
                return ConcurrentLinkedList!Type.init;

            ConcurrentLinkedList!Type ret;
    ...
    ///
    void insert(ptrdiff_t index, ConcurrentLinkedList!Type other) scope {
        setupState;
    ...
    ///
    unittest {
        ConcurrentLinkedList!Type cll1, cll2;
        cll1 ~= Type.init;
    ...
    ///
    void prepend(ConcurrentLinkedList!Type other) scope {
        setupState;
    ...
    ///
    void append(ConcurrentLinkedList!Type other) scope {
        setupState;
    ...
    ///
    void opOpAssign(string s : "~")(ConcurrentLinkedList!Type input) scope {
        this.append(input);
    }
    ...
    @PrintIgnore @PrettyPrintIgnore {
        ...
        void toString(scope ref StringBuilder_UTF8 builder) @trusted {
            if(isNull)
                builder ~= "ConcurrentLinkedList!(" ~ Type.stringof ~ ")@null";
            else
                builder.formattedWrite("ConcurrentLinkedList!(" ~ Type.stringof ~ ")@{:p}(length={:d})",
